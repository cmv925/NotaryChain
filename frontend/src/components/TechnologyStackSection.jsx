    ...
    <section className="py-24 bg-cream-100">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          {/* AI Brain */}
          <Card className="bg-gradient-to-br from-coral-500/20 to-navy-700/20 border-2 border-coral-300/50">
            <CardContent className="p-8">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-16 h-16 bg-coral-500/20 rounded-xl flex items-center justify-center">
                  <Cpu className="w-8 h-8 text-coral-500" />
                </div>
                <div>
                  <h3 className="text-3xl font-bold text-white">AI - The Intelligent Brain</h3>
                  <p className="text-coral-400 text-sm">Powered by Google Gemini</p>
                </div>
              </div>
          ...
          {/* Blockchain Body */}
          <Card className="bg-gradient-to-br from-green-600/20 to-coral-600/20 border-2 border-green-500/50">
            <CardContent className="p-8">
              <div className="flex items-center gap-4 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-coral-500/10 to-coral-600/5 border border-coral-300/30 rounded-xl p-6 text-center">
            <div className="w-12 h-12 bg-coral-500/20 rounded-full flex items-center justify-center mx-auto mb-4">
              <Cpu className="w-6 h-6 text-coral-500" />
            </div>
          ...
          <div className="bg-gradient-to-br from-navy-700/10 to-navy-700/5 border border-navy-300/30 rounded-xl p-6 text-center">
            <div className="w-12 h-12 bg-navy-600/20 rounded-full flex items-center justify-center mx-auto mb-4">
              <UserCheck className="w-6 h-6 text-navy-500" />
            </div>
