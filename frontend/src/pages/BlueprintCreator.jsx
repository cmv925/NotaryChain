        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">Design a custom transaction workflow template</p>
            </div>
          </div>
            ...
            <Card className="bg-[#1a1a2e] border-[#333]">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm text-gray-400 mb-1 block">Est. Duration (Days)</label>
                    <Input
                      type="number"
                ...
                {blueprint.steps.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {blueprint.steps.map((step, index) => (
                      <div 
                        key={step.id} 
                        className="bg-[#0d1b2a] rounded-lg border border-[#333] overflow-hidden"
                      >
                        {/* Step Header */}
                        <div 
                          className="p-4 flex items-center gap-3 cursor-pointer hover:bg-[#1a1a2e]"
                        ...
                        >
                          ...
                          <div className="h-8 w-8 rounded-full bg-[#00d4aa]/20 flex items-center justify-center text-[#00d4aa] font-bold">
                            {step.order}
                          </div>
                        ...
                        {expandedStep === step.id && (
                          <div className="p-4 border-t border-[#333] space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                              ...
                              <div>
                                <label className="text-xs text-gray-400 mb-1 block">Est. Duration (Hours)</label>
                                <Input
                                  type="number"
                            ...
                            {/* Requirements */}
                            <div>
                              <label className="text-xs text-gray-400 mb-2 block">Requirements</label>
                            ...
                            {/* Assigned Roles */}
                            <div>
                              <label className="text-xs text-gray-400 mb-2 block">Responsible Roles</label>
                                  ...
                                  <button
                                    ...
                                    className={`px-2 py-1 rounded text-xs transition-colors ${
                                      step.required_roles.includes(role)
                                        ...
                                        : 'bg-[#1a1a2e] text-gray-400 border border-[#333] hover:border-[#555]'
                                    }`}
                                  >
                                    {role}
                                  </button>
                            ...
                            {index > 0 && (
                              <div>
                                <label className="text-xs text-gray-400 mb-2 block">Depends On (Steps that must complete first)</label>
                                <div className="flex flex-wrap gap-1">
                    ...
                    <button
                      ...
                      className={`px-2 py-1 rounded text-xs transition-colors ${
                        blueprint.required_roles.includes(role)
                          ? 'bg-blue-500/20 text-blue-400 border border-blue-500/50'
                          : 'bg-[#0d1b2a] text-gray-400 border border-[#333] hover:border-[#555]'
                      }`}
                    >
                      {role}
                    </button>
                ...
                {blueprint.required_documents.length > 0 && (
                  <div className="space-y-1">
                    {blueprint.required_documents.map((doc, idx) => (
                      <div key={idx} className="flex items-center justify-between p-2 bg-[#0d1b2a] rounded text-sm">
            ...
            <Card className="bg-[#1a1a2e] border-[#333]">
              ...
              <CardContent>
                <div className="flex items-center justify-between">
                  <span className="text-gray-400 text-sm">Enable AI Orchestration</span>
                  <button
                    onClick={() => setBlueprint({ ...blueprint, ai_enabled: !blueprint.ai_enabled })}
                    className={`w-10 h-5 rounded-full transition-colors ${
                      blueprint.ai_enabled ? 'bg-[#00d4aa]' : 'bg-[#333]'
                    }`}
                  >
        ...
        <DialogContent className="bg-[#1a1a2e] border-[#333] text-navy-900 max-w-2xl max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-4 mt-4">
            <div>
              ...
              <p className="text-gray-400 text-sm">{blueprint.description || 'No description'}</p>
            </div>
