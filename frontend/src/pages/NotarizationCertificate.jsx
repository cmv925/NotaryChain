...
export default function NotarizationCertificate() {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-cream-100 flex items-center justify-center p-4">
        <Card className="bg-white border-red-500/30 max-w-md w-full">
          <CardContent className="p-8 text-center">
            <XCircle className="h-16 w-16 text-red-500 mx-auto mb-4" />
            <h2 className="text-xl font-bold text-navy-900 mb-2">Certificate Not Available</h2>
            <p className="text-slate-500 mb-6">{error}</p>
            <Button onClick={() => navigate(-1)} variant="outline" className="border-slate-200">
  ...
  return (
    <div className="min-h-screen bg-cream-100 text-navy-900 p-4 md:p-8 print:bg-white print:text-black">
      ...
      <div className="max-w-4xl mx-auto mb-6 print:hidden">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Button onClick={handlePrint} variant="outline" className="border-slate-200">
      ...
      <div 
        ref={certificateRef}
        className="max-w-4xl mx-auto bg-gradient-to-br from-white to-cream-100 rounded-2xl border border-slate-200 overflow-hidden print:bg-white print:border-slate-300 print:shadow-lg"
      >
        {/* Certificate Header */}
        <div className="bg-gradient-to-r from-coral-500/20 to-coral-500/5 border-b border-slate-200 p-8 text-center print:bg-gray-100">
          <div className="flex justify-center mb-4">
            <div className="h-20 w-20 rounded-full bg-coral-500/20 flex items-center justify-center print:bg-green-100">
              <Shield className="h-10 w-10 text-coral-600 print:text-green-600" />
            </div>
          </div>
          <h1 className="text-3xl font-bold text-navy-900 mb-2 print:text-black">
            Digital Notarization Certificate
          </h1>
          <p className="text-coral-600 font-semibold print:text-green-600">
        ...
        <div className="p-8 space-y-8">
          ...
          <div>
            <h2 className="text-lg font-bold text-navy-900 mb-4 flex items-center gap-2 print:text-black">
              <FileText className="h-5 w-5 text-coral-600 print:text-green-600" />
              Document Information
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 bg-cream-100 rounded-lg p-4 print:bg-gray-50">
              <div>
                <p className="text-slate-500 text-sm print:text-slate-500">Document Name</p>
                <p className="text-navy-900 font-medium print:text-black">{certificate?.document?.name || 'N/A'}</p>
              </div>
              <div>
                <p className="text-slate-500 text-sm print:text-slate-500">Document Type</p>
                <p className="text-navy-900 font-medium print:text-black">{certificate?.document?.type || 'N/A'}</p>
              </div>
              <div>
                <p className="text-slate-500 text-sm print:text-slate-500">Notarization Type</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="bg-cream-100 rounded-lg p-4 print:bg-gray-50">
                ...
                <p className="text-slate-500 text-sm print:text-slate-600">{certificate?.requester?.email}</p>
              </div>
            </div>
            <div>
              <h2 className="text-lg font-bold text-navy-900 mb-4 flex items-center gap-2 print:text-black">
              ...
              <div className="bg-cream-100 rounded-lg p-4 print:bg-gray-50">
                ...
                <p className="text-slate-500 text-sm print:text-slate-600">{certificate?.notary?.email}</p>
              ...
              <div className="bg-cream-100 rounded-lg p-4 print:bg-gray-50">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-xs print:text-slate-600">Document Verification</p>
                  </div>
                </div>
                <Badge className={`${
                  certificate?.verifications?.document_analysis?.performed 
              ...
              <div className="bg-cream-100 rounded-lg p-4 print:bg-gray-50">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-xs print:text-slate-600">Identity Verification</p>
                  </div>
                </div>
                <Badge className={`${
                  certificate?.verifications?.biometric?.completed 
              ...
              <div className="bg-cream-100 rounded-lg p-4 print:bg-gray-50">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-xs print:text-slate-600">Remote Notarization</p>
                  </div>
                </div>
                <Badge className={`${
                  certificate?.verifications?.video_session?.completed 
          ...
          <div>
            <h2 className="text-lg font-bold text-navy-900 mb-4 flex items-center gap-2 print:text-black">
              <Link2 className="h-5 w-5 text-coral-600 print:text-green-600" />
              Blockchain Proof
            </h2>
            <div className="bg-cream-100 rounded-lg p-6 print:bg-gray-50">
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                <div className="flex-1 space-y-4">
                  <div>
                    <p className="text-slate-500 text-sm print:text-slate-500">Network</p>
                    <p className="text-navy-900 font-medium print:text-black">{certificate?.blockchain_proof?.network}</p>
                  </div>
                  <div>
                    <p className="text-slate-500 text-sm print:text-slate-500">Package Hash (SHA-256)</p>
                    <div className="flex items-center gap-2">
                      <code className="text-coral-600 text-sm font-mono break-all print:text-green-600">
                        {certificate?.blockchain_proof?.package_hash}
                      </code>
                      <button 
                        onClick={copyHash}
                        className="p-1 hover:bg-slate-200 rounded print:hidden"
                      >
                        {copied ? (
                  ...
                  <div>
                    <p className="text-slate-500 text-sm print:text-slate-500">HCS Topic ID</p>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-slate-500 text-xs mt-2 text-center print:text-slate-600">Scan to verify</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {certificate?.component_hashes && Object.entries(certificate.component_hashes).map(([key, hash]) => (
                hash && (
                  <div key={key} className="bg-cream-100 rounded-lg p-3 print:bg-gray-50">
                    <p className="text-slate-500 text-xs capitalize print:text-slate-500">{key.replace(/_/g, ' ')}</p>
          ...
          {/* Legal Statement */}
          <div className="border-t border-slate-200 pt-6 print:border-slate-300">
          ...
          {/* Issue Date */}
          <div className="text-center text-slate-500 text-sm print:text-slate-600">
            <p>Issued: {certificate?.issued_at ? new Date(certificate.issued_at).toLocaleString() : 'N/A'}</p>
            <p className="mt-2 font-semibold text-coral-600 print:text-green-600">NotaryChain™ - Secure. Immutable. Trusted.</p>
          </div>
        </div>
      </div>
