...
2. A green banner appears with the full public URL, e.g.
   `https://acn-oracle-live.preview.emergentagent.com/compliance/snapshot/OCPTr3gnxtXZiVfRY7IJvw`
...
```html
<script src="https://acn-oracle-live.preview.emergentagent.com/api/trustlayer/badge-v2.js"></script>
...
### 11.2 Load the SDK
```html
<script src="https://acn-oracle-live.preview.emergentagent.com/api/sdk/v1/notarychain.js"></script>
<script>
...
window.addEventListener('message', (ev) => {
  if (ev.origin !== 'https://acn-oracle-live.preview.emergentagent.com') return;
