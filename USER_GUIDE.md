...
2. A green banner appears with the full public URL, e.g.
   `https://notary-vault-dev.preview.emergentagent.com/compliance/snapshot/OCPTr3gnxtXZiVfRY7IJvw`
...
```html
<script src="https://notary-vault-dev.preview.emergentagent.com/api/trustlayer/badge-v2.js"></script>
...
### 11.2 Load the SDK
```html
<script src="https://notary-vault-dev.preview.emergentagent.com/api/sdk/v1/notarychain.js"></script>
<script>
...
window.addEventListener('message', (ev) => {
  if (ev.origin !== 'https://notary-vault-dev.preview.emergentagent.com') return;
