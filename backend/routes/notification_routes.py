...
class NotificationCreate(BaseModel):
    title: str
    message: str
    type: str = "info"  # info, success, warning, action
...
async def create_notification(
    ...
    # Try to push via WebSocket (user might be in a transaction room)
    # We broadcast to a special "notifications:{user_id}" channel
    try:
        # Check all rooms for this user and send
