...
RON_STATE_RULES = {
    ...
    "SC": {"name": "South Carolina", "status": "prohibited", "effective_date": null, "id_requirements": [], "witnesses_required": 0, "recording_required": false, "journal_required": false, "max_signers_per_session": 0, "allowed_doc_types": [], "notes": "No RON legislation enacted"},
